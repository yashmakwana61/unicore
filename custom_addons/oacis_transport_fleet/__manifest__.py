{
    ...
    'version': '19.0.1.0.0',
    'category': 'Education',
    'summary': 'Bridge Oacis transport vehicles into Odoo Fleet management',
    'description': """
        Transport Fleet Integration
        ===========================

        Bridges Oacis's transport vehicle records into Odoo's native Fleet
        ...
        Key behaviour:
        - A ``fleet.vehicle`` is auto-created when a Oacis transport vehicle
        ...
        - The Fleet app is made visible to Oacis transport staff via implied
          ``fleet.group_user``.

        No core ``oacis_transport`` or ``fleet`` logic is modified.
    """,
    ...
    'web_icon': 'oacis_transport_fleet,static/description/icon.png',
    'installable': True,
    'application': False,
    'auto_install': False,
}
