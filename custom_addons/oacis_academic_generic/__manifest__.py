{
    'name': 'UniCore Generic Academic Structure',
    'version': '19.0.1.0.0',
    'category': 'Education',
    ...
    'description': """
        ...
        This module is ADDITIVE ONLY: it introduces unicore.academic.unit as a
        depth-unlimited, self-referencing, type-configurable tree and does not
        modify unicore_academic in any way. The terminal node (program / cohort /
    ...
    'data': [
        ...
        'data/unicore_academic_unit_type_data.xml',
        'views/unicore_academic_unit_type_views.xml',
        'views/unicore_academic_unit_views.xml',
        'menus/unicore_academic_generic_menus.xml',
    ],
    'installable': True,
    'application': False,
    'auto_install': False,
