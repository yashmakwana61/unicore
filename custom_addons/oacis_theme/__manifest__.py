...
- Mobile-responsive layout
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            'oacis_theme/static/src/scss/kanban-design-system.scss',
            'oacis_theme/static/src/scss/kanban-components.scss',
            'oacis_theme/static/src/scss/kanban-variants.scss',
