{
    'name': 'Oacis Institution Profile',
    'version': '19.0.1.3.0',
    'category': 'Education',
    ...
    'data': [
        ...
        'data/oacis_institution_profile_data.xml',
        'data/oacis_institution_profile_templates.xml',
        'views/oacis_institution_feature_views.xml',
        'views/oacis_terminology_profile_views.xml',
        'views/oacis_grading_scheme_views.xml',
        'views/oacis_institution_profile_views.xml',
        'views/res_company_views.xml',
        'menus/oacis_institution_profile_menus.xml',
    ],
