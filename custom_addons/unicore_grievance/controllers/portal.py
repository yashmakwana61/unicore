...
class GrievancePortal(CustomerPortal):
    ...
    def portal_my_grievances(self, **kwargs):
        ...
        Grievance = request.env['unicore.grievance.request']
        ...
        return request.render("unicore_grievance.portal_my_grievances", values)

    @http.route(['/my/grievance/new'], type='http', auth="user", website=True)
    def portal_my_grievance_new(self, **kwargs):
        categories = request.env['unicore.grievance.category'].search([])
        values = {
            'categories': categories,
            'page_name': 'grievance_new',
        }
        return request.render("unicore_grievance.portal_grievance_new", values)
    ...
    def portal_my_grievance_submit(self, **post):
        ...
        request.env['unicore.grievance.request'].sudo().create({
