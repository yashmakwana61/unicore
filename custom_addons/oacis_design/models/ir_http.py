...
class IrHttp(models.AbstractModel):
    ...
    def session_info(self):
        ...
        user = self.env.user
        if user:
            res['oacis_theme_config'] = user._get_oacis_theme_config()
            res['oacis_theme_pinned_apps'] = user.theme_pinned_apps.ids
            res['oacis_workspace_data'] = user.theme_get_workspace_data()
        return res
    ...
    def lazy_session_info(self):
        ...
        if user and user._is_internal():
            ...
            res['oacis_theme_hash'] = theme_hash
        return res
